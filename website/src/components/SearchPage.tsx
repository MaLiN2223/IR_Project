...
export default class SearchPage extends Component<{}, SearchState> {
      ...
      .catch((err) => {
        if (!err.response) {
          const displayMessage =
            "Unexpected error happened: Network Error. If you want to, please contact Malin with this message.";
          ...
          if (status === 429) {
            const displayMessage =
              "You are being rate limited. You excideed the following limit: " +
              message +
            ...
            const displayMessage =
              ...
              message +
              ", if you want to, please contact Malin with this message.";
            this.setState({ error: displayMessage });
          }
        }
        return false;
