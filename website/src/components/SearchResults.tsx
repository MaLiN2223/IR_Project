                  ...
                  {show_scores ? (
                    <Card.Footer>
                      <div>
                        ...
                        <br /> Modified score: {result.modified_score}
                      </div>
                    </Card.Footer>
                  ) : (
                    ""
                  ...
                  {is_debug ? (
                    <Card.Footer>
                      <div>
                        FT smilarity:{" "}
                        {
                          result.debugInformation.debug_scores
                            .processed_text_similarity
                        }
                        <br /> Negative BM:{" "}
                        {result.debugInformation.debug_scores.negative_score}
                      </div>
                    </Card.Footer>
                  ) : (
                    ""
